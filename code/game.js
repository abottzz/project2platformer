...
Hazard.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};

var wobbleSpeedBonus = 5;
var wobbleDistBonus = 2;
Win.prototype.act = function(step) {
	this.wobble += step * wobbleSpeedBonus;
	var wobblePos = Math.sin(this.wobble) * wobbleDistBonus;
